...
import com.example.adapter.ChatKhachHangAdapter;
...
public class ChamSocKhachHangChatActivity extends AppCompatActivity {
    FloatingActionButton fabSend;
    EditText edtInput;
    RecyclerView rcyMessege;
    ImageView imgBack;
    ChatKhachHangAdapter adapter;
        ...
        fabSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mData.child(child).child(emails[0])
                        .push()
                        .setValue(new ChatMessage(edtInput.getText().toString(),"Support", urlImage));
                edtInput.setText("");
            }
        });
    ...
    private void addControls() {
        ...
        user= (User) intent.getSerializableExtra("KHACHHANG");
        emails=user.getEmail().split("@");
        ...
        rcyMessege.setLayoutManager(new LinearLayoutManager(ChamSocKhachHangChatActivity.this));
        adapter = new ChatKhachHangAdapter(ChamSocKhachHangChatActivity.this, dsMessages, nhanVien);
