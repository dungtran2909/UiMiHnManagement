...
public class ChatKhachHangAdapter extends RecyclerView.Adapter<ChatKhachHangAdapter.ViewHolder> {
    ...
    public ChatKhachHangAdapter(Context context, ArrayList<ChatMessage> chatData, NhanVien nhanVien) {
        mContext = context;
    ...
    public int getItemViewType(int position) {
        ...
        if (chatMessage!=null) {
            if (chatMessage.getMessageUser().equals("Support")) {
                return TYPE_OWER;
            } else
                return TYPE_GUEST;
        } else
